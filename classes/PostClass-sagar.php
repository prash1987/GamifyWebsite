...
class PostClass {
	...
	public function submitPost($body, $location, $play_time, $image_path) {
		...
		$insert_stmnt = "INSERT INTO posts(body, posted_by, time_stamp, location, play_time, image_path, likes, men_only, women_only) VALUES('$body','$posted_by','$time_stamp', '$location', '$play_time', '$image_path',0,'N','Y')";
	...
	public function loadPostsFriends($gender_pref,$game_pref)
	{
		...
		if ($gender_pref == 'M' || $gender_pref == 'F') {
