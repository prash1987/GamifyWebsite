...
class PostClass {
	...
	//Load posts of specific groups
	public function loadPostsGroups($group_id) {
		...
		$query = "SELECT * FROM posts WHERE group_id='$group_id' AND deleted = 0 ORDER BY time_stamp DESC";
		$str = ""; //String to return 
		//$con = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
		$data_query = mysqli_query($this->con, $query);  
		$delete_button = "";
